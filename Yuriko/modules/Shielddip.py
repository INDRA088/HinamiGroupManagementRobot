...
# from Yuriko.db.mongo_helpers.nsfw_guard import add_chat, get_all_nsfw_chats, is_chat_in_db, rm_chat
...
__help__ = """
<b> Group Guardian: </b>
✪ Hinami can protect your group from NSFW senders, Slag word users and also can force members to use English
...
Note: Special credits goes to @DIPUID
